...
<html lang="en">
  ...
  <body>
    ...
    <section id="mv">
      ...
      <div class="container">
        <div class="text_box">
          <div class="box_inner">
            <details class="mb-1">
              <summary><b>원숭이두창이란?</b></summary>
              <p>
                원숭이 두창(Monkeypox)은 천연두와 우두 등이 포함된
                오르토폭스바이러스 속의 원숭이 두창 바이러스(Monkeypox virus,
                MPXV)가 일으키는 희귀 인수공통전염병이다. 본래 MPXV는 중서부
                아프리카의 열대우림에 서식하는 원숭이 사이에서 전파되는
                바이러스이나, 감염된 동물에 접촉한 사람에게도 발병한다.
                <br />
                <br />
                1958년 덴마크 코펜하겐의 실험용 원숭이에서 최초로 발견되었으며,
                1970년 인간에 대한 발병이 보고된 이후 각지에서 감염 사례가
                보고되고 있다.원숭이 두창의 치명률은 약 10% 미만으로, 인간
                두창인 천연두에 비해서는 증상과 치명률이 낮으나
                오르토폭스바이러스속의 다른 바이러스처럼 전파율이 높으며
          ...
          <div class="box_inner">
            <details class="mb-1">
              <summary><b> 감염경로</b></summary>
              <p>
                1. 감염 환자의 혈액 또는 체액(타액, 소변, 구토물 등) 등이
                피부상처 또는 점막을 통해 직접 접촉으로 인한 감염
                <br />
                2. 환자의 혈액이나 체액으로 오염된 옷, 침구류, 감염된 바늘 등이
                사람의 점막, 피부 상처 등 접촉으로 인한 감염
                <br />
                3. 감염된 원숭이, 다람쥐 등 동물과의 직접 접촉으로 인한 감염
              </p>
            </details>
          </div>
          <div class="box_inner">
            <details class="mb-1">
              <summary><b>발현증상</b></summary>
              <p>
          ...
          <div class="box_inner">
            <details class="mb-1">
              <summary><b>검사 관련</b></summary>
              <p>
                현재 원숭이두창 진단검사는 질병관리청에서 검사 가능합니다.
                <br />
    ...
    <footer id="ft">
      <div class="foot_box text-secondary text-center small">
        <address>
          Monkey Magic
          <br />
